...
class PlotTerrain: 
    ...
    def plot(self, method: str, data_list: list = None): 

        fig = plt.figure(figsize=(12,8))
        ax = fig.add_subplot(111, projection='3d')

        # self.__plot_terrain_surface(ax)
    ...
    def __plot_terrain_surface(self, ax): 
        ...
        # XXX: sorting
        surf = ax.plot_surface(x, y, z, label='Terrain Data')#, label = 'Franke function')
    ...
    def __2d_plot_model(self, model: str, ax): 
        ...
        # If 2 dim
        z_model = o.predict(self.terrain_object.get_X_test())
        N = self.terrain_object.N
...
if __name__ == '__main__': 
    ...
    t = terrain_data.TerrainData(5, 500)
    p = PlotTerrain(t)
